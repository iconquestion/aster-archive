...
function get_json_response(trigger_ele_id, response_show_ele_id, fetch_url, fetch_attrs = {}) {
    document.getElementById(trigger_ele_id).addEventListener("click", async () => {
