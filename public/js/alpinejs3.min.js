(() => {
  ...
  function rr(t) {
    for (t._x_effects?.forEach(qe); t._x_cleanups?.length; )
      t._x_cleanups.pop()();
  }
  ...
  function In() {
    ...
    let e = ut.length;
    queueMicrotask(() => {
      if (ut.length === e) for (; ut.length > 0; ) ut.shift()();
    });
  }
  function m(t) {
    if (!le) return t();
...
`
      ...
      xr(r) ||
        n.some((i) => {
          if (document.querySelector(i))
            return (S(`found "${i}", but missing ${e} plugin`), !0);
        });
    });
  }
  var Ee = [],
  ...
  function ti(t, e, r) {
    ...
    (i &&
      ...
      (t._x_transition.enter.start = { opacity: u, transform: `scale(${l})` }),
  ...
  function _n(t = !1, e = !1) {
    return function (n, i, o) {
      ...
      if (i === '__v_raw' && o === (t ? (e ? Ki : bn) : e ? Ui : yn).get(n))
        return n;
      let s = U(n);
  ...
  function Ni(t = !1) {
    return function (r, n, i, o) {
      ...
      return (
        r === h(o) &&
          (a ? Re(i, s) && q(r, 'set', n, i, s) : q(r, 'add', n, i)),
        c
      );
    };
  }
  ...
  var Ii = { get: Ci, set: Ri, deleteProperty: Pi, has: Di, ownKeys: ki },
    $i = {
      get: Ti,
      set(t, e) {
        return (
  ...
  function cn(t, e) {
    ...
    return (
      r.set(t, e),
      o ? Re(e, s) && q(r, 'set', t, e, s) : q(r, 'add', t, e),
      this
    );
  }
  function un(t) {
  ...
  function Jt(t, e, r) {
    return function (...n) {
      ...
      return (
        ...
        {
          next() {
            let { value: f, done: b } = u.next();
            return b
              ? { value: f, done: b }
              : { value: a ? [l(f[0]), l(f[1])] : l(f), done: b };
          },
          [Symbol.iterator]() {
            return this;
          },
  ...
  p('teleport', (t, { modifiers: e, expression: r }, { cleanup: n }) => {
    t.tagName.toLowerCase() !== 'template' &&
      S('x-teleport can only be used on a <template> tag', t);
    let i = On(r),
      ...
      e === 'submit' &&
        (o = a(o, (c, u) => {
          (u.target._x_pendingModelUpdates &&
            u.target._x_pendingModelUpdates.forEach((l) => l()),
            c(u));
        })),
      (to(e) || Mn(e)) &&
        (o = a(o, (c, u) => {
  ...
  p('show', (t, { modifiers: e, expression: r }, { effect: n }) => {
    ...
    n(() =>
      i((f) => {
        (!l && f === u) ||
          (e.includes('immediate') && (f ? a() : o()), c(f), (u = f), (l = !1));
      })
    );
  });
  ...
  function ao(t, e, r, n) {
    r((i) => {
      (lo(i) && (i = Array.from({ length: i }, (u, l) => l + 1)),
        i === void 0 && (i = []),
          ...
          if (s.has(f)) {
            ...
            (d._x_refreshXForScope(b),
              l.nextElementSibling !== d &&
                (l.nextElementSibling && d.replaceWith(l.nextElementSibling),
                l.after(d)),
              (l = d),
              d._x_currentIfEl &&
                (d.nextElementSibling !== d._x_currentIfEl &&
                  l.after(d._x_currentIfEl),
                (l = d._x_currentIfEl)));
            return;
          }
  ...
  function Pn() {}
  Pn.inline = E((t, { expression: e }, { cleanup: r }) => {
    let n = Y(t);
    (n._x_refs || (n._x_refs = {}),
      (n._x_refs[e] = t),
  ...
  p('if', (t, { expression: e }, { effect: r, cleanup: n }) => {
    t.tagName.toLowerCase() !== 'template' &&
      S('x-if can only be used on a <template> tag', t);
    let i = _(t, e),
      o = () => {
  ...
  p(
    'on',
    E((t, { value: e, modifiers: r, expression: n }, { cleanup: i }) => {
      let o = n ? _(t, n) : () => {};
      t.tagName.toLowerCase() === 'template' &&
